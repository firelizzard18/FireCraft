...
public class FireCraftRenderingHandler implements ISimpleBlockRenderingHandler {
	RenderBlocks helper = new RenderBlocks();
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
		if (modelId == SilmarilBlock.RENDERID)
			return renderSilmarilBlock((SilmarilBlock)block, x, y, z);
    ...
    boolean renderSilmarilBlock(SilmarilBlock silmaril, int x, int y, int z)
    {
        boolean flag = false;
        int l = 0;
